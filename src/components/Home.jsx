...
const Home = () => {
  ...
  return (
    <>
     <marquee class="blink blink-clr">SUMMER INTERNSHIP PROGRAM(SIP)-2026: a bridge course for Biotechnology and Biomedical Engineers. Course duration - 1st June to 15th July. Last date for apply - 27th May 2026.</marquee>
      <Carousel />
